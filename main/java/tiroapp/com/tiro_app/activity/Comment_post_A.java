...
import tiroapp.com.tiro_app.adapter.AdapterComment;
...
public class Comment_post_A extends AppCompatActivity {
    ...
    public void readResponse(JSONArray comments){
        try {
            List<RowsComment> data = new ArrayList<>();
            JSONArray arr = comments;
            ...
            for (int i = 0; i < count; i++){
                ...
                current.date = arr.getJSONObject(i).getString("dateCreation");
