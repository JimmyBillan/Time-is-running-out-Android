...
import com.tiro_app.tiro_app.adapter.AdapterFollow;
import com.tiro_app.tiro_app.controller.RowsFollowing;

public class List_follow extends AppCompatActivity {

    protected RecyclerView mRecyclerView;
    protected AdapterFollow mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(bundle != null) {
            typeFollow = bundle.getString("TYPE");
        }
    ...
    private void createAdapterAndSet(){
        mAdapter = new AdapterFollow(dataset);
        mRecyclerView.setAdapter(mAdapter);
    }

    private void requestDataforRecyclerFollowing() {

        String URL = "http://tiro-app.com/user/"+typeFollow;
        ...
        JsonObjectRequest req = new JsonObjectRequest(Request.Method.GET, URL, null,
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            if (response.getBoolean("success")) {
                                ...
                                startActivity(new Intent(List_follow.this, LogIn_A.class));
                            }
            ...
            public void onErrorResponse(VolleyError error) {
                Toast toast = Toast.makeText(List_follow.this, "Check your connection or Server problem check out our twitter", Toast.LENGTH_LONG);
                toast.show();
    ...
    private void readDataforRecyclerFollowing(JSONObject response){
        ...
        JSONArray arr;
        try {
            arr = response.getJSONArray("listFollow");
